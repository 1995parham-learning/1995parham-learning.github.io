...
export default {
    propertyDefaults: { title: "Fără titlu", description: "Nici o descriere furnizată" },
    components: {
        callout: {
            note: "Notă",
            abstract: "Rezumat",
        ...
        backlinks: { title: "Legături înapoi", noBacklinksFound: "Nu s-au găsit legături înapoi" },
        themeToggle: { lightMode: "Modul luminos", darkMode: "Modul întunecat" },
        ...
        search: { title: "Căutare", searchBarPlaceholder: "Introduceți termenul de căutare..." },
