...
export default {
    ...
    components: {
        ...
        backlinks: { title: "反向链接", noBacklinksFound: "无法找到反向链接" },
        themeToggle: { lightMode: "亮色模式", darkMode: "暗色模式" },
        explorer: { title: "探索" },
        ...
        contentMeta: { readingTime: ({ minutes }) => `${minutes}分钟阅读` },
    },
    pages: {
        rss: { recentNotes: "最近的笔记", lastFewNotes: ({ count }) => `最近的${count}条笔记` },
        error: { title: "无法找到", notFound: "私有笔记或笔记不存在。", home: "返回首页" },
        folderContent: {
            folder: "文件夹",
